...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    protected ArrayList<E> leftSubTree(E e, TreeNode<E> root) {
        ArrayList<E> leftNode = new ArrayList<E>();
        TreeNode<E> current = root;
        if (search(e) == true) {
    ...
    protected ArrayList<E> rightSubTree(E e, TreeNode<E> root) {
        ArrayList<E> rightNode = new ArrayList<E>();
        TreeNode<E> current = root;
        if (search(e) == true) {
            System.out.println(current.element);
            System.out.println(e);
    ...
    public boolean sameTree(BinarySearchTree tree1, BinarySearchTree tree2) {
        if ((tree1 == null) && (tree2 == null)) {
            return true;
        } else if (tree1.root.element.equals(tree2.root.element) && tree2.leftSubTree(tree2.root.element).equals(tree1.leftSubTree(tree1.root.element)) && tree2.rightSubTree(tree2.root.element).equals(tree1.rightSubTree(tree1.root.element))) {
            return true;
        } else {
            return false;
        }
